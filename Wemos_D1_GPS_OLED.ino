...
Adafruit_ssd1306syp display(D2,D1);                       // OLED display (SDA to Pin 2), (SCL to Pin 1)

static const int RXPin = D8, TXPin = D7;                // Ublox 6m GPS module to pins 8 and 7
static const uint32_t GPSBaud = 9600;                   // Ublox GPS default Baud Rate is 9600

const double Home_LAT = -80.5138;                      // Your Home Latitude
const double Home_LNG = 40.5344;                     // Your Home Longitude
...
{  
  ...
  display.println("Eric's GPS");  
  display.println("Come Get Some");
